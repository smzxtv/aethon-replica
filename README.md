...
| Stage | Scope | Status |
| --- | --- | --- |
| 0 | Windows skeleton: Tauri v2 + React shell, three-part navigation, core fetch script | ✅ in progress |
| 1 | SOCKS5 mode (`127.0.0.1:1819`) + VPN mode (TUN + protected routes), connect/disconnect, live diagnostics | ⏳ |
